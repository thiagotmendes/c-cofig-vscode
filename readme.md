# Uma forma simples de usar o VSCode para C/C++
...
![configuração](https://imgur.com/TOLzeYr.png)

Resultado do teste compilado:

![terminal rodando o codigo](https://imgur.com/RlizE47.png)
